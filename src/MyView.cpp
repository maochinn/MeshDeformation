...
void MyView::draw()
{
	...
	if (gladLoadGL())
	{
		...
		if (!this->gl_mesh)
		{
			...
			this->gl_mesh->Init("../MeshDeformation/Models/sphere.obj");
		}
		...
		if (!this->texture)
			this->texture = new Texture2D("../MeshDeformation/Images/church.png");

		if (!this->skybox) {
			this->skybox = new CubeMap(
				Shader(
					common_lib + Shader::readCode("../MeshDeformation/src/shaders/cubeMap.vert"),
					std::string(), std::string(), std::string(),
					material_lib + Shader::readCode("../MeshDeformation/src/shaders/cubeMap.frag")),
				"../MeshDeformation/Images/skybox/right.jpg",
				"../MeshDeformation/Images/skybox/left.jpg",
				"../MeshDeformation/Images/skybox/top.jpg",
				"../MeshDeformation/Images/skybox/bottom.jpg",
				"../MeshDeformation/Images/skybox/back.jpg",
				"../MeshDeformation/Images/skybox/front.jpg");
		}
	}
	else
